...
# ╔═╡ 887f9512-56f8-4c01-8206-55f926f9d6be
import Pkg

# ╔═╡ 0692b0b0-1798-11f0-14eb-f3a92b62b0b4
using CSV

# ╔═╡ 3252e954-424c-477d-a3d8-f08b258f2505
using DataFrames

# ╔═╡ 581be843-f9e0-4ff1-94e6-8cd677b51b49
using Statistics

# ╔═╡ 04ecd803-bf6f-46b7-b322-a308921eccae
using Plots

# ╔═╡ 9c94a0c7-e7f4-4c47-a336-7364c7c0b465
using MLJ

# ╔═╡ 30ca39fa-80c2-471d-9da8-1277aa74c7c8
using MLJModels

# ╔═╡ 7ea9645c-61c4-49ac-8b75-f3605912a64e
using PrettyPrinting

# ╔═╡ 265d2d53-1fa6-4507-8dea-dda88182db99
using StatsPlots

# ╔═╡ d2e3e197-ed6c-4482-9515-faca36b862a4


# ╔═╡ a43cadea-aa8b-4add-b0ce-2fe6ab40a922
#Loading data

# ╔═╡ 566b169e-3d23-45a8-88ad-bc2154cc6d8d
begin
...
# ╔═╡ c8c7ee54-b454-484f-8b3e-db2611ee60f1
begin
	# Check class distribution
	fetal_counts = combine(groupby(df, :fetal_health), nrow => :Count)
	@df fetal_counts bar(:fetal_health, :Count, title="Fetal Health Class Distribution")
	
	# Correlation heatmap
	cor_matrix = cor(Matrix(select(df, Not(:fetal_health))))
	heatmap(cor_matrix, title="Feature Correlation Heatmap")
end

# ╔═╡ 96ad5344-b612-47fb-a739-9363f6bf7ebc
#2. Model implemetation

# ╔═╡ 54c76d1d-bd20-4d5c-88bf-18a84af31af4
y, X = unpack(df, ==(:fetal_health), rng=123)

# ╔═╡ 9a811050-f3aa-4445-96ca-cfdc947fd644
# Label encoding (in case fetal_health is not categorical)
z = coerce(y, Multiclass)

# ╔═╡ d060951e-2e40-4db6-ac63-1654e4d0ae0c
#TRAINING MODEL

# ╔═╡ 22b67a16-8e0b-4851-8915-863dabf633b6
#random forest

# ╔═╡ d38a48fc-25ad-4124-8998-b16344acbf47


# ╔═╡ e6d07541-bbfc-4211-af0d-e11fa0c0d9d6


# ╔═╡ 59521854-694a-4104-80c4-93c4a5033043
begin
...
# ╔═╡ 08c19f24-30c5-463c-b6b1-5f23a02423c3
#TRAINING A LOGISTIC 

# ╔═╡ edbe469e-f9b4-49da-bf2a-b5eb3da26448
begin
	@load LogisticClassifier pkg=MLJLinearModels
	logistic_model = LogisticClassifier()
	
	logistic_mach = machine(logistic_model, X, y)
	fit!(logistic_mach)
...
manifest_format = "2.0"
project_hash = "5ec1de51e4eaf694b647770cc504c3d4dd87c277"
